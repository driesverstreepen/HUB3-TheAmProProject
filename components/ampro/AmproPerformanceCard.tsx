  ...
  return (
    <div className="h-full">
      <Link
        ...
        className="w-full bg-white rounded-3xl p-4 flex flex-col relative overflow-visible elev-1 h-full min-h-[180px] group hover:bg-slate-50"
      >
        {/* color accent removed */}

        {deadlinePassed ? (
          <div className="absolute inset-0 rounded-3xl bg-slate-200/60 flex items-center justify-center pointer-events-none">
        ...
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            <h3 className="t-h3 font-semibold min-w-0 truncate text-slate-900">{performance.title}</h3>
            {performance.description ? (
              <p className="mt-2 t-bodySm text-slate-600 line-clamp-3">{performance.description}</p>
            ) : null}
          ...
          <div className="shrink-0 rounded-full p-1 text-slate-500 group-hover:text-slate-700">
